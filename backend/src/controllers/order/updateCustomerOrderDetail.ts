...
export const updateCustomerOrderDetail = async (req: Request, res: Response) => {
    try {
        ...
        const detail = await prisma.customerOrderDetail.update({
            where: { id },
            data: {
        ...
        res.status(500).json({
            success: false,
            message: 'Error updating customer order detail',
